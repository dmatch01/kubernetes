...
func (s *SchedulerServer) addCoreFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&s.kubeletNetworkPluginDirectory, "kubelet-network-plugin-dir", s.kubeletNetworkPluginDirectory, "<Warning: Alpha feature> The name of the network plugin to be invoked for various events in kubelet/pod lifecycle")
